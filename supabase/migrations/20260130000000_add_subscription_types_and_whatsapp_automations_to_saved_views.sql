...
-- Add new constraint that includes 'subscription_types' and 'whatsapp_automations'
ALTER TABLE saved_views 
  ADD CONSTRAINT saved_views_resource_key_check 
  CHECK (resource_key IN ('leads', 'workouts', 'customers', 'templates', 'nutrition_templates', 'budgets', 'meetings', 'check_in_settings', 'payments', 'collections', 'subscription_types', 'whatsapp_automations'));

-- Insert subscription_types default view for all users
