...
--              For internal usage by staff/managers
-- =====================================================
...
COMMENT ON TABLE public.internal_knowledge_base IS 'Internal knowledge base for storing video links and resources for staff/managers';
