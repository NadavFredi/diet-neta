...
COMMENT ON FUNCTION "public"."get_filtered_leads"("p_limit_count" integer, "p_offset_count" integer, "p_search_query" "text", "p_status_main" "text", "p_status_sub" "text", "p_source" "text", "p_fitness_goal" "text", "p_activity_level" "text", "p_preferred_time" "text", "p_age" "text", "p_height" "text", "p_weight" "text", "p_date" "text") IS 'RPC function for complex lead filtering. All filtering happens in PostgreSQL. Includes both birth_date and age columns.';
...
COMMENT ON TABLE "public"."proposals" IS 'Generic proposals table for storing proposal data and managing proposal lifecycle';



COMMENT ON COLUMN "public"."proposals"."external_proposal_id" IS 'Optional external proposal ID if provided by an external system';
