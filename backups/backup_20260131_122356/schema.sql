...
CREATE OR REPLACE FUNCTION "public"."log_steps_plan_changes"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    changes_json JSONB;
...
ALTER FUNCTION "public"."log_steps_plan_changes"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."log_supplement_plan_changes"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    changes_json JSONB;
...
ALTER FUNCTION "public"."log_supplement_plan_changes"() OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "log_steps_plan_changes_trigger" AFTER INSERT OR UPDATE ON "public"."steps_plans" FOR EACH ROW EXECUTE FUNCTION "public"."log_steps_plan_changes"();



CREATE OR REPLACE TRIGGER "log_supplement_plan_changes_trigger" AFTER INSERT OR UPDATE ON "public"."supplement_plans" FOR EACH ROW EXECUTE FUNCTION "public"."log_supplement_plan_changes"();
...
GRANT ALL ON FUNCTION "public"."log_steps_plan_changes"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_steps_plan_changes"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_steps_plan_changes"() TO "service_role";



GRANT ALL ON FUNCTION "public"."log_supplement_plan_changes"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_supplement_plan_changes"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_supplement_plan_changes"() TO "service_role";
